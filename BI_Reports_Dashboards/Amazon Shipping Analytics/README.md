...
- Clone my repository here ===> (https://github.com/balusena/balugithub/tree/master/BI_Reports_Dashboards/Amazon Shipping Analytics) 


### 5.Amazon Shipping Analytics Dashboard

![Shipping Analytics Dashboard!](Amazon Shipping Analytics.PNG)
